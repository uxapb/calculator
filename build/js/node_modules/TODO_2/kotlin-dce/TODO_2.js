(function (root, factory) {
  ...
  Coroutine$Form$init$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Form.$metadata$ = {kind: Kind_CLASS, simpleName: 'Form', interfaces: [RComponent]};
